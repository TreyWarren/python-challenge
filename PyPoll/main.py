...
with open(output_path, 'w') as output:
    ...
    writer.writerow(['-------------------------'])
    writer.writerow(['Total Votes:', len(candidates_list)])
    writer.writerow(['-------------------------'])
    writer.writerow([candidate_1, ': %',round(percent_1,3), tally_1])
    writer.writerow([candidate_2, ': %',round(percent_2,3), tally_2])
    writer.writerow([candidate_3, ': %',round(percent_3,3), tally_3])
    writer.writerow([candidate_4, ': %',round(percent_4,3), tally_4])
    writer.writerow(['-------------------------'])
    writer.writerow(['Winner:',candidate_1])
    writer.writerow(['-------------------------'])
